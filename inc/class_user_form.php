          ...
          <div class="section-questions">
            ...
            <?php if($this->form_type == "new"): ?>
                ...
                <div class="question_row cf form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control" name="username" id="username" value="<?php echo $this->username; ?>" /> 
                    </div>
                </div>
            ...
            <div class="question_row cf form-group">
                ...
                <div class="col-sm-4">                
                    <input type="text" class="form-control form-control" name="first_name" value="<?php echo $this->first_name; ?>" /> 
                </div>
            </div>
            ...
            <div class="question_row cf form-group">
                ...
                <div class="col-sm-4">                                    
                    <input type="text" class="form-control form-control" name="last_name" value="<?php echo $this->last_name; ?>" />
                </div>
            </div>
            ...
            <div class="question_row cf form-group">
                ...
                <div class="col-sm-4">                                                        
                    <input type="text" class="form-control form-control"  name="title" value="<?php echo $this->title; ?>" /> 
                </div>
            </div>
            ...
            <div class="question_row cf form-group">
                ...
                <div class="col-sm-4">   
                    <input type="text" class="form-control form-control" name="email" value="<?php echo $this->email; ?>" />
                </div>
            </div>
            ...
            <div class="question_row cf form-group">
                ...
                <div class="col-sm-4">   
                    <input type="text" class="form-control form-control" name="tel_no" value="<?php echo $this->tel_no; ?>" />                     
                </div>
            </div>       
                ...
                <div class="col-sm-4">    
                    ...
                    <select name="usertype" id="usertype" class="form-control">
                        ...
                        ?>
                            ...
                            <option value="<?php echo $role_id; ?>" <?php $this->isSelected($role_id, $this->user_role_id); ?>><?php echo $role_name; ?></option>              
             ...
             <select name="company" id="company" class="form-control">
                <option value="" disabled selected> -- Select Company -- </option>
                  <?php 
                      ...
                      <option value="<?php echo $company_id; ?>" <?php $this->isSelected($company_id, $this->company_id); ?>><?php echo $company_name; ?></option>              
