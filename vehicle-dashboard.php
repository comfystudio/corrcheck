...
<?php $user->check_dashboard_premission();?>
<?php
                                            ...
                                            <tr>
                                                ...
                                                <?php for($i = 1; $i <= $number_weeks; $i++){?>
                                                    ...
                                                    <td class = "<?php echo $class;?>">
                                                        <!-- START BLOCK OF PSV, SCHEDULED AND UNSCHEDULED INSPECTIONS -->
                        ...
                        <div class="block">
                            ...
                            <table class="table table-striped table-borderless table-vcenter">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a class = "btn btn-effect-ripple btn-sm btn-success"><span class="fa-stack fa-1x"><i class="fa fa-wrench" aria-hidden="true"></span></i></a></td>
                                        <td>
                                            A scheduled inspection has been carried out. You can click to read inspection.
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><a class = "btn btn-effect-ripple btn-sm btn-warning"><span class="fa-stack fa-1x"><i class="fa fa-wrench" aria-hidden="true"></i></span></i></a></td>
                                        <td>
                                            A unscheduled inspection has been carried out.
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>This is the vehicles PSV date. Can be changed in vehicle management.</td>
                                    </tr>
                                    <tr>
                                        <td><a class = "btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-calendar" aria-hidden="true"></i></a></td>
                                        <td>This is the upcoming vehicle inspection based on service interval in the Vehicle management.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
