...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2014 at 05:18 PM
...
(2, 'Corr Brothers Ltd', '101 Ballyards Road', 'Armagh', NULL, 'BT60 3NS', 'enquiries@corrbrothers.com', '028 3752 5245', '028 3752 6997');
...
CREATE TABLE IF NOT EXISTS `tbl_surveys` (
  ...
  `supervised_by_user_ID` int(11) NOT NULL,
  ...
  KEY `supervised_by_user_ID` (`supervised_by_user_ID`),
...
INSERT INTO `tbl_surveys` (`survey_ID`, `vehicle_type`, `vehicle_reg`, `company_ID`, `make_model`, `odo_reading`, `odo_type`, `pre_service_remarks`, `notes_parts_list`, `completed_by_user_ID`, `supervised_by_user_ID`, `survey_date`, `date_last_update`, `user_last_update`) VALUES
(58, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(59, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(60, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(61, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(62, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(63, 'lorry', 'DEX8998', 1, 'FORD BOYO', 987654, 'km', 'Some remarks', 'Need some bits and bobs for this report', 2, 1, '0000-00-00', '0000-00-00', 2),
(64, 'lorry', 'Test1234', 1, 'lorry car thing', 12455, 'km', '', '', 2, 1, '0000-00-00', '0000-00-00', 2);
...
(1, 'mick', 'Mick', 'Corr', 'Manager', 'accounts@corrbrothers.co.uk', '+44 (0) 28 3752 5245', 1, 2, '', ''),
...
(6, '', '', '', '', '', '', 1, 1, '578ef09e4fb8e9f8', '825090a52094507f64d41ddb5955eb8a7a46b0c6abd41ad987c677a65993d4db'),
(7, '', '', '', '', '', '', 1, 1, '7d309a6fe2c695f', '7676f91b2953b9cbe5cafd03573a824a5aceb0e09f737f6238b4be0606dae7dd'),
(8, '', '', '', '', '', '', 1, 1, '5baab59150a3d68f', '444de4854faa4ea3c2273589fab63494f5909708dde42cec28afca32bf7c6e0f'),
(9, '', '', '', '', '', '', 1, 1, '7c0a04c4654c19ff', 'ab8817241250fbc6539d051b3fbf43058bf5ba742156941ba52a128e8076ef11'),
(10, '', '', '', '', '', '', 1, 1, '20c958496fee6630', 'b2a4f17cd7a52ed8972359ef935428a77f19ceaac87808fa8f21b7d116bb93b0'),
(11, '', '', '', '', '', '', 1, 1, '7d83aabf987eb37', '80a6e1b04b91c03f6db0e23e6d4d9c61ce71e5d17c2fc63cf6cef846e6b1b30c'),
...
ALTER TABLE `tbl_surveys`
  ...
  ADD CONSTRAINT `tbl_surveys_ibfk_3` FOREIGN KEY (`supervised_by_user_ID`) REFERENCES `tbl_users` (`user_id`),
